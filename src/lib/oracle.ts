...
- Rooms: Temple, House (wall/grid), Feed, Scan (wired to LinkScan at militiamarie.github.io/linkscan — QR + barcodes, Cash App, NFT URLs; hits return to Scan), Market, Productions (Coinbase / Base), Studio (anyone can mint their own playable 1/1), Grimoire (intent reducer → sigil plate), Stage, Vault.
